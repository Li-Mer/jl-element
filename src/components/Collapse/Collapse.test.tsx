...
//       },
//     );
//     const headers = wrapper.findAll(".jl-collapse-item__header");
//     const contents = wrapper.findAll(".jl-collapse-item__content");
...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".jl-collapse-item__header");
    contents = wrapper.findAll(".jl-collapse-item__content");
  ...
  //test.only 可以只运行这个测试 test.skip 可以跳过这个测试
